...
const Home = () => {
  ...
  return (
    <>
      {loading ? (
        <div className="my-5 px-5 lg:px-20 h-[350px] flex justify-center items-center">
          <span className="loading loading-ring loading-lg"></span>
        </div>
      ) : (
        <div className="my-5 px-5 lg:px-20">
          {/* =================================== banner section ==================================== */}
          <Banner banners={allProduct?.banners}></Banner>
          {/* categoris section  */}
          ...
          {/* vegetables section */}
          <VegetablesSection
            vegetable={allProduct?.vegetable}></VegetablesSection>
          {/* Fish section */}
